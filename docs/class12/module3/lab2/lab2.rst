...
On your events shell you should see Kubernetes creating the Replica Set, the pod, and the Kubelet pulling the image and getting the container running. A replica set resides
