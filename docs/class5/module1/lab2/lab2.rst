...
1. In the NIM Dashboard, click **Instances** to return to the instance list.

.. image:: images/nim_instance_list.png

2. Click the  **nginx-plus-1** NGINX instance from the list.

.. image:: images/nim_instance_manager_active_instance.png
...
.. image:: images/nim_instance_detail_edit_config.png
...
.. image:: images/nim_instance_config.png
...
.. image:: images/nim_arcadia_config.png
