...
4. Now you can click on 'Instance Groups' to see the Instance Group created. 
...
8. Click the 'Statistics' tab and you'll see all nginx instances are 
currently enabled where nginx-1 has 'Preferred' resolutions listed under 'Load 
Balancing'.
